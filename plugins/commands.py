...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('𝙿𝚁𝙸𝚅𝙰𝚃𝙴 𝙱𝙾𝚃', url=f"https://t.me/mr_flickz")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('💠 CHΛИИΞL 💠', url='https://t.me/MRflicks'),
            InlineKeyboardButton('💠 UᎮDΛTΞS 💠', url='https://t.me/MrFlicks_updates')
            ],[      
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('CONTACT ME', url='https://t.me/mr_flickz'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
            ],[
            InlineKeyboardButton('✅ SUBSCᏒIBΞ  ✅', url='https://t.me/komban_movies')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
